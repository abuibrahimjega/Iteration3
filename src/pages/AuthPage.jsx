    ...
    <div className="auth-container">
      ...
      <div className="auth-hero">
        <img
          ...
          className="auth-logo"
        />
        <h1 className="auth-title">Virtual Umrah</h1>
        <p className="auth-description">
          Experience Umrah in a 3D environment, access educational resources,
          and join discussions to post and comment with fellow pilgrims.
        </p>
      </div>
